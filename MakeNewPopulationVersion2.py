...
class MakePop():
    def MakeNewPopulation(self, F,Pt1,i,gen,MaxIndividualsInGen,lengthOfFront1And2):
        ...
        for num in range(0,MaxIndividualsInGen-lengthOfFront1And2):
            ...
            NewIndividualID= self.Crossover(StoreIndividualID1,StoreIndividualID2,gen,MaxIndividualsInGen)
    ...
    def Crossover(self, StoreIndividualID1,StoreIndividualID2,gen,MaxIndividualsInGen):
